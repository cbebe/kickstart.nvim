...
vim.keymap.set('n', '<leader>sF', function()
  require('telescope.builtin').find_files({ find_command = { "rg", "--files", "-uuu", "-g", "!.git" } })
end
...
vim.keymap.set('n', '<leader>sG', function()
  require('telescope.builtin').live_grep({ find_command = { "rg", "-uuu", "-g", "!.git" } })
